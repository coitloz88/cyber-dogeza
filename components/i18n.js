...
export const translations = {
  ko: {
    ...
    title_p3: "사이버 숲속 도게자 — 긴급 사죄 방송",
    title_p4: "사이버 공중 도게자 — 긴급 사죄 방송",
    title_p5: "사이버 우주 도게자 — 긴급 사죄 방송",
    ...
    h1_p3:
      '사이버<span class="stamp" id="titleStamp" style="color:#7ade4a; text-shadow:0 0 12px #4ade80;">숲속</span>도게자',
    h1_p4:
      '사이버<span class="stamp" id="titleStamp" style="color:#87cefa; text-shadow:0 0 12px #4a90d8;">공중</span>도게자',
    h1_p5:
      '사이버<span class="stamp" id="titleStamp" style="color:#b070ff; text-shadow:0 0 12px #7030c0;">우주</span>도게자',
    ...
    btn_to_forest: "숲 속으로 이동",
    btn_to_sky: "하늘로 이동",
    btn_to_space: "우주로 이동",
    musk_p5: "화성 갈끄니까",
    musk_p5_arrival: "화성 도착 🚀",
    lib_big: "解 脱",
  ...
  ja: {
    ...
    title_p3: "サイバー森林土下座 — 緊急謝罪放送",
    title_p4: "サイバー空中土下座 — 緊急謝罪放送",
    title_p5: "サイバー宇宙土下座 — 緊急謝罪放送",
    badge: "⚠ EMERGENCY BROADCAST · 緊急謝罪 ⚠",
    ...
    h1_p3:
      'サイバー<span class="stamp" id="titleStamp" style="color:#7ade4a; text-shadow:0 0 12px #4ade80;">森林</span>土下座',
    h1_p4:
      'サイバー<span class="stamp" id="titleStamp" style="color:#87cefa; text-shadow:0 0 12px #4a90d8;">空中</span>土下座',
    h1_p5:
      'サイバー<span class="stamp" id="titleStamp" style="color:#b070ff; text-shadow:0 0 12px #7030c0;">宇宙</span>土下座',
    ...
    btn_to_water: "水の中へ移動",
    btn_to_fire: "火の中へ移動",
    btn_to_forest: "森の中へ移動",
    btn_to_sky: "空へ移動",
    btn_to_space: "宇宙へ移動",
    musk_p5: "火星行くっから",
    musk_p5_arrival: "火星到着 🚀",
    lib_big: "解 脱",
